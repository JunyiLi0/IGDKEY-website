      ...
      <section className="section-padding padding-x-lg">
            ...
            <div className="service-card card-border rounded-xl p-8 flex flex-col gap-4 md:col-span-2">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="card-border rounded-lg p-6 bg-gradient-to-br from-black-100 to-black-200">
                    <h4 className="text-white text-xl font-semibold mb-2">Automatisation des processus métiers</h4>
                  ...
                  <div className="card-border rounded-lg p-6 bg-gradient-to-br from-black-100 to-black-200">
                    <h4 className="text-white text-xl font-semibold mb-2">Personnalisation selon vos outils existants</h4>
                    <p className="text-white-50 leading-relaxed">
        ...
        <div ref={processRef} className="w-full mb-20">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <div className="grid-2-cols gap-8">
              <div className="process-step card-border rounded-xl p-8 flex flex-col gap-4 bg-gradient-to-br from-black-100 to-black-200">
        ...
        <div ref={ctaRef} className="w-full mb-12">
          <div className="max-w-4xl mx-auto">
            <div className="card-border rounded-2xl p-10 md:p-16 bg-gradient-to-br from-purple-900/20 to-blue-900/20 text-center">
